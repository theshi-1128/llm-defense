...
def parse_args():
    ...
    parser.add_argument('--assist_model_cuda_id', type=str, default="cuda:0", help='CUDA device for the assist model')
    parser.add_argument('--moderation_model_cuda_id', type=str, default="cuda:0", help='CUDA device for the moderation model')
    parser.add_argument('--zero_shot_model_cuda_id', type=str, default="cuda:0", help='CUDA device for the zero-shot model')
